...
DocMeta.setdocmeta!(Envelopt, :DocTestSetup, :(using Envelopt); recursive = true)
...
makedocs(;
  modules = [Envelopt],
  authors = "Alberto DeMarchi <aldmarchi@gmail.com>, Dominique Orban <dominique.orban@gmail.com>",
  repo = "https://github.com/JuliaSmoothOptimizers/Envelopt.jl/blob/{commit}{path}#{line}",
  sitename = "Envelopt.jl",
  format = Documenter.HTML(; canonical = "https://JuliaSmoothOptimizers.github.io/Envelopt.jl"),
  pages = list_pages(),
)

deploydocs(; repo = "github.com/JuliaSmoothOptimizers/Envelopt.jl")
